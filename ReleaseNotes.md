...
## 1.0.4
+ Documents the use of yarn instead of npm
### Issues
...
+ Fixes script dev 
### Issues
+ Lots of vulnarabilities from dependencies
+ Lots of "zoom out" unwanted visual effect - from version 1.0.2
+ Provide user data access to admin while click on username
+ Prevent to users type space in password
+ Change slug of reset password page to 'atualizar-senha'
...
## 1.0.1
+ Loads data from one person at a time in the page 'contributors'
+ Icon to see player data has a "pointer" cursor
### Issues
+ Provide user data access to admin while click on username
+ Prevent to users type space in password
+ Change slug of reset password page to 'atualizar-senha'
...
## 0.23.0
+ Lists contributions
+ Allows managers see contributors without enrollments
...
## 0.22.0
+ Permits admins to see profiles data
### Issues
+ Prevent to users type space in password
+ Change slug of reset password page to 'atualizar-senha'
+ Provide some solution to db requests when running in the LAN
